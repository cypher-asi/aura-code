...
fn project_from_network(net: &NetworkProject, local: Option<&Project>) -> Project {
    ...
    if let Some(local) = local {
        Project {
            ...
            github_integration_id: local.github_integration_id,
            github_repo_full_name: local.github_repo_full_name.clone(),
...
pub async fn update_project(
    ...
    let input = UpdateProjectInput {
        ...
        github_integration_id: req.github_integration_id,
        github_repo_full_name: req.github_repo_full_name.clone(),
