...
pub use aura_protocol::{
    ...
    FileOp, FilesChanged, GenerationCompleted, GenerationErrorMsg, GenerationPartialImage,
    GenerationProgressMsg, GenerationRequest, GenerationStart,
    InboundMessage as HarnessInbound, InstalledTool, MessageAttachment,
