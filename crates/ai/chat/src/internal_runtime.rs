...
//!
//! Also contains bidirectional type conversion helpers between the harness
//! boundary types and the Claude wire types used by the inner tool loop.
...
// ===========================================================================
// Reverse conversions (Claude wire types → harness boundary types)
//
// Used by ChatService / DevLoopEngine to build TurnRequests from their
// existing Claude-typed data, so they can call `runtime.execute_turn()`.
// ===========================================================================
